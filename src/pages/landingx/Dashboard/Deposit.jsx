...
const Deposit = () => {
  ...
  const [code, setCode] = useState(
    "bc1qaqlpmnrnk37yjtsm0gtm2avg8m65yckjlpqvt8"
  );
  ...
  const onCoinChange = (e) => {
    ...
    if (value == "btc") {
      setBarcode("btc");
      setCode("bc1qaqlpmnrnk37yjtsm0gtm2avg8m65yckjlpqvt8");
    } else if (value == "eth") {
      setBarcode("eth");
      setCode("0x0c493C14e265A1eb25Dc8Ac70C2e287CE56381b0");
    } else if (value == "usdt") {
      setBarcode("usdt");
      setCode("0x0c493C14e265A1eb25Dc8Ac70C2e287CE56381b0");
    } else if (value == "bank") {
  ...
  const onDeposit = async () => {
    ...
    const res = await fetch(
      "https://calm-rose-frog-kilt.cyclic.app/deposit",
      {
        method: "POST",
              ...
              <div class="flex flex-col items-center font-semibold text-2xl px-6 pt-8 h-full">
                ...
                >
                  <div className="p-2 bg-white border border-slate-200">
                    ...
                    <div>Please visit support@braxtrade.net</div>
                  </div>
                </Modal>
              </div>
            </section>
